...
<body>
    <div class="container">
        <form method="post" action="" class="formSmall">
            <center><a href="index.php"><img src="image.png"width="320"></a></center>
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="input-group">
                        <input type="text" class="form-control" name="video_link" placeholder="https://www.youtube.com/watch?v=OK_JCtrrv-c">
